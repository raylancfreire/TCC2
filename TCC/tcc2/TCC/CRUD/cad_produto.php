...
if (isset($_FILES['imagem'])) {
    ...
    if ($funciona) {
        $cad_prod = $pdo->prepare("INSERT INTO produtos (nome_produto, descricao, marca, categoria, preco, quantidade_produto, imagem, path) VALUES (:nome_produto, :descricao, :marca, :categoria, :preco, :quantidade_produto, :imagem, :path)");
