        ...
        <div class="row">
          ...
          if ($result->rowCount() > 0) {
            foreach ($result as $row) {
              ...
              echo '<img class="product-image" src="upload/' . $row['path'] . '" alt="Imagem do produto" width="200" height="200">';
              ...
              echo '<a href="tela_compra.php?comprar=' . $row['id_produto'] . '" class="btn btn-success">COMPRAR</a>';
              echo '</div>';
              echo '</div>';
            }
          } else {
